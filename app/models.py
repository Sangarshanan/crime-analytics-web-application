...
class murder(models.Model):
	...
	Victims_Above_50_Yrs = models.IntegerField(null=True,validators=[MaxValueValidator(100), MinValueValidator(1)])
	Victims_Total = models.IntegerField(null=True,validators=[MaxValueValidator(100), MinValueValidator(1)])
	Victims_Upto_10_15_Yrs=models.IntegerField(null=True,validators=[MaxValueValidator(100), MinValueValidator(1)])
	Victims_Upto_10_Yrs = models.IntegerField(null=True,validators=[MaxValueValidator(100), MinValueValidator(1)])
	Victims_Upto_15_18_Yrs = models.IntegerField(null=True,validators=[MaxValueValidator(100), MinValueValidator(1)])
	Victims_Upto_18_30_Yrs = models.IntegerField(null=True,validators=[MaxValueValidator(100), MinValueValidator(1)])
	Victims_Upto_30_50_Yrs = models.IntegerField(null=True,validators=[MaxValueValidator(100), MinValueValidator(1)])
